...
def plot_heatmap(directory, data, title, difference_to=None, color_map=plt.cm.Reds, vmin=None, vmax=None):
        ...
        fig.savefig(os.path.join(directory,title+".pdf"), bbox_inches='tight')
